...
func TestToSrid(t *testing.T) {
	c := NewGoProjCoordinateConverter()
	...
	// GOPROJ unfortunately does not yet support some coordinate conversions
	...
	//	t.Fatalf("unexpected error %v", err)
	//}
	//expected = geom.Coord{X: 1552074.5400524682, Y: 1895674.6033419219, Z: -65.466696}
	//if err := utils.CompareCoord(actual, expected, coordTolerance); err != nil {
	//	t.Errorf("expected coordinate %v, got %v. Err: %v", expected, actual, err)
	//}
