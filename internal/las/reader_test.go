...
func TestReader(t *testing.T) {
	...
	expectedWOcolor := []geom.Point64{
		{Vector3: geom.Vector3{X: 432488.4714159001, Y: 4.705678720925195e+06, Z: 2.550538045727727}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432466.58372129063, Y: 4.705686414284739e+06, Z: 4.457767479175496}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432469.98167019564, Y: 4.705681849831438e+06, Z: 4.655027394763156}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432456.1696575739, Y: 4.705683863015449e+06, Z: 1.7922372985151949}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432465.34641605255, Y: 4.705682466042181e+06, Z: 1.9543476118949155}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432471.7795208326, Y: 4.705664509499522e+06, Z: 1.9162578617315837}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432449.48655283387, Y: 4.705672817604579e+06, Z: 2.7424278273838762}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432457.86106384156, Y: 4.705682649635591e+06, Z: 2.081788046497537}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432466.3000286405, Y: 4.705680013894157e+06, Z: 1.9357872046388636}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
		{Vector3: geom.Vector3{X: 432455.7336230836, Y: 4.705657784890012e+06, Z: 6.120847715554042}, R: 0, G: 0, B: 0, Intensity: 7, Classification: 3},
	}
	...
	expectedPf7 := []geom.Point64{
		{Vector3: geom.Vector3{X: 432488.4714159001, Y: 4.705678720925195e+06, Z: 2.550538045727727}, R: 160, G: 166, B: 203, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432466.58372129063, Y: 4.705686414284739e+06, Z: 4.457767479175496}, R: 186, G: 200, B: 237, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432469.98167019564, Y: 4.705681849831438e+06, Z: 4.655027394763156}, R: 156, G: 167, B: 204, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432456.1696575739, Y: 4.705683863015449e+06, Z: 1.7922372985151949}, R: 107, G: 114, B: 156, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432465.34641605255, Y: 4.705682466042181e+06, Z: 1.9543476118949155}, R: 165, G: 176, B: 206, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432471.7795208326, Y: 4.705664509499522e+06, Z: 1.9162578617315837}, R: 90, G: 136, B: 213, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432449.48655283387, Y: 4.705672817604579e+06, Z: 2.7424278273838762}, R: 51, G: 66, B: 87, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432457.86106384156, Y: 4.705682649635591e+06, Z: 2.081788046497537}, R: 80, G: 97, B: 123, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432466.3000286405, Y: 4.705680013894157e+06, Z: 1.9357872046388636}, R: 160, G: 169, B: 202, Intensity: 7, Classification: 90},
		{Vector3: geom.Vector3{X: 432455.7336230836, Y: 4.705657784890012e+06, Z: 6.120847715554042}, R: 73, G: 78, B: 110, Intensity: 7, Classification: 90},
	}
	...
	for _, e := range entries {
		...
		for i := 0; i < 10; i++ {
			...
			} else if r.f.Header.PointFormatID == 7 {
				if actual != expectedPf7[i] {
					t.Errorf("for file %s, expected point %v got %v", filename, expectedPf7[i], actual)
				}
			} else {
